...
名前・社員番号・メールアドレスを読みから素早く変換できるようになります。
...
備考列はオプションです。所属部署などを記載できます。Google日本語入力への登録の際に、備考の項目を変換候補の補足事項として表示することができ、例えば同姓同名の変換候補の区別などに便利です。
...
nimoji 専用の辞書を分けておくことで、他の辞書に影響を与えずに安全に差し替えできます。
